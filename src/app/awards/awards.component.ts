  ...
  onMouseMove(event: MouseEvent | TouchEvent) {
    if (this.mouseDownPosition !== null) {
      ...
      if (this.mouseDownPosition !== null) {
        ...
        const mouseDelta = parseFloat(this.mouseDownPosition.toString()) - clientX;
        const maxDelta = window.innerWidth / 2;
        
        const nextPercentageUnconstrained = parseFloat(track.dataset['prevPercentage'] || "0") + (mouseDelta / maxDelta) * -100;
